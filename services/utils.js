...
export type APIMethods = {
  ...
  verifymessage: (vidulumaddress: string, signature: string, message: string) => Promise<boolean>,
  z_validateaddress: (
    zaddr: string,
  ) => Promise<{
    isvalid: boolean,
  ...
  dumpprivkey: (vAddr: string) => Promise<string>,
  dumpwallet: (filename: string) => Promise<string>,
  encryptwallet: (passphrase: string) => Promise<void>,
  getaccount: (vidulumaddress: string) => Promise<string>,
  ...
  getreceivedbyaddress: (vidulumaddress: string, minconf?: number) => Promise<number>,
  gettransaction: (
    txid: string,
  ...
  importprivkey: (vidulumprivkey: string, label?: string, rescan?: boolean) => Promise<void>,
  ...
  setaccount: (vidulumaddress: string, account: string) => Promise<void>,
  settxfee: (amount: number) => Promise<boolean>,
  signmessage: (vAddr: string, message: string) => Promise<string>,
