...
describe('formatNumber', () => {
  test('should append VDL in balance amount', () => {
    const myBalance = formatNumber({ value: 2.5, append: 'VDL ' });

    const expectedState = 'VDL 2.5';

    expect(myBalance).toEqual(expectedState);
  });

  test('should multiply VDL balance and show it in USD', () => {
  ...
  test('should multiply decimal VDL balance and show it in USD', () => {
    const myBalanceInUsd = formatNumber({
